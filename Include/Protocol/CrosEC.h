...
typedef INTN(EFIAPI* EFI_CROSEC_SEND_COMMAND)(IN UINTN Command,
                                              IN UINTN Version,
                                              IN CONST VOID* Data,
                                              IN UINTN Size,
...
typedef INTN(EFIAPI* EFI_CROSEC_READMEM)(IN UINTN Offset, OUT VOID* Buffer, IN UINTN Length);

typedef struct _EFI_CROSEC_PROTOCOL {
	EFI_CROSEC_SEND_COMMAND SendCommand;
	EFI_CROSEC_READMEM ReadMemory;
} EFI_CROSEC_PROTOCOL;
